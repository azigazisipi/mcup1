...
iron_man = media.Movie("Iron Man",
    "When wealthy industrialist Tony Stark is forced to build an armored "
    "suit after a life-threatening incident, he ultimately decides to use"
    " the technology to fight against evil.",
...
the_i_hulk = media.Movie("The Incredible Hulk",
    "Thanks to a gamma ray experiment gone wrong, Dr. Bruce Banner must deal"
    " with the side effects as well as being hunted by the military. Meanwhile,"
    " a soldier uses the same technology to become a deadly abomination.",
...
iron_man_2 = media.Movie("Iron Man 2",
    "With the world now aware of his dual life as an "
    "armored superhero, billionaire inventor Tony Stark"
    " faces pressure from the government, the press, and"
    " the public to share his technology with the "
    "military, along with dealing with an insane Russian"
    " genius who is intent on killing him.",
...
thor = media.Movie("Thor",
    "The powerful but arrogant Asgardian Thor is cast out from"
    " his home to live among humans on Earth, where he must "
    "learn humility, and ends up finding love.",
...
cap_am_tfa = media.Movie("Captain America: The First Avenger",
    "After being deemed unfit for military service, Steve Rogers"
    " volunteers for a top secret research project that turns"
    " him into Captain America, a superhero dedicated to "
...
the_avengers = media.Movie("The Avengers",
    ...
    " cohorts, Nick Fury of S.H.I.E.L.D. assembles "
    "a team of superheroes to "
